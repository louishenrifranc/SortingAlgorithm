...
public class QuickSort extends TriPanel {
	...
	protected void paintComponent(java.awt.Graphics g){
		...
		if(barreOrange != -2) {
			...
			g.fillRect(2 * BORDER_WIDTH + columnWidth * barreOrange, getHeight() - list.get(barreOrange) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(barreOrange) * columnHeight);
			g.drawRect(2 * BORDER_WIDTH + columnWidth * barreOrange, getHeight() - list.get(barreOrange) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(barreOrange) * columnHeight);
		}
		if(barreJaune != -2) {
			g.setColor(Color.YELLOW);
			g.fillRect(2 * BORDER_WIDTH + columnWidth * barreJaune, getHeight() - list.get(barreJaune) * columnHeight - 2 * BORDER_WIDTH, columnWidth,list.get(barreJaune) * columnHeight);
			g.drawRect(2 * BORDER_WIDTH + columnWidth * barreJaune, getHeight() - list.get(barreJaune) * columnHeight - 2 * BORDER_WIDTH, columnWidth,list.get(barreJaune) * columnHeight);
		}
