        ...
        protected void paintComponent(java.awt.Graphics g){
                ...
                if(SIGNAL_FIN == -1){
                        ...
                        for (int i = (barreVerte == -2 ? 0 : barreVerte); i < taille; i++) {
                                ...
                                g.fillRect(2 * BORDER_WIDTH + columnWidth * i, getHeight() - list.get(i) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(i)* columnHeight);
                                g.drawRect(2 * BORDER_WIDTH + columnWidth * i, getHeight() - list.get(i) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(i) * columnHeight);
                        }
                        ...
                        if(barreRouge != -2) {
                                ...
                                g.fillRect(2 * BORDER_WIDTH + columnWidth * barreRouge, getHeight() - list.get(barreRouge) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(barreRouge) * columnHeight);
                                g.drawRect(2 * BORDER_WIDTH + columnWidth * barreRouge, getHeight() - list.get(barreRouge) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(barreRouge) * columnHeight);
                        }
                        if(barreBleue != -2) {
                                g.setColor(java.awt.Color.CYAN);
                                g.fillRect(2 * BORDER_WIDTH + columnWidth * barreBleue, getHeight() - list.get(barreBleue) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(barreBleue) * columnHeight);
                                g.drawRect(2 * BORDER_WIDTH + columnWidth * barreBleue, getHeight() - list.get(barreBleue) * columnHeight - 2 * BORDER_WIDTH, columnWidth, list.get(barreBleue) * columnHeight);
                        }
                }
