...
public class Menu extends JFrame
{
	...
	public MDialog(int i)
	{
	    ...
	    try
	    {
		if (i == Constante.codeQuickSort) website = new JEditorPane(
		        "http://zanotti.univ-tln.fr/algo/TRI-RAPIDE.html" );
		else if (i == Constante.codeHeapSort) website = new JEditorPane(
		        "http://zanotti.univ-tln.fr/algo/TRI-TAS.html" );
		else if (i == Constante.codeBubbleSort) website = new JEditorPane(
		        "http://zanotti.univ-tln.fr/algo/TRI-BULLES.html" );
		else if (i == Constante.codeSelectionSort) website = new JEditorPane(
	...
	ImageIcon ii = new ImageIcon( Paths.get( "" ).toAbsolutePath()
	        .toString()
	...
	reglageCommun.setBorder( BorderFactory.createTitledBorder(
	...
	int value = 1000;
	JPanel statistiques = new JPanel( new GridLayout( 7 , 3 ) );
	...
	statistiques.add( checkBox5 );
	JLabel lblNewLabel_5 = new JLabel( "Nombre de valeurs" );
	statistiques.add( lblNewLabel_5 );
	JSpinner spinner5 = new JSpinner();
	statistiques.add( spinner5 );
	spinner5.setValue( value *= 1.5 );
	...
	statistiques.add( checkBox6 );
	JLabel lblNewLabel_6 = new JLabel( "Nombre de valeurs" );
	statistiques.add( lblNewLabel_6 );
	JSpinner spinner6 = new JSpinner();
	statistiques.add( spinner6 );
	spinner5.setValue( value *= 1.25 );
	checkBox5.addActionListener( new ActionListener()
	{
	...
	listeWest.add( checkBox5 );
	listeWest.add( spinner5 );
	listeWest.add( lblNewLabel_5 );
	listeWest.add( checkBox6 );
	listeWest.add( spinner6 );
	listeWest.add( lblNewLabel_6 );
	...
	visualisation.setBorder( BorderFactory.createTitledBorder(
	        BorderFactory.createLineBorder( Color.blue , 4 ) ,
	        "Visualisation" ) );
	...
	btnLancer.addActionListener( new ActionListener()
	{
		...
		else
		{
			...
			if (checkBox1.isSelected())
			{
			    ...
			    if (valeur > 0) tableauValeurs.addElement( valeur );
			}
			...
			{
			    valeur = ( int ) spinner5.getValue();

			    if (valeur > 0) tableauValeurs.addElement( valeur );
			}
			if (checkBox6.isSelected())
			{
			    valeur = ( int ) spinner6.getValue();

			    if (valeur > 0) tableauValeurs.addElement( valeur );
			}
			// Trier les valeurs
			Collections.sort( tableauValeurs );
			// Creer un objet affichage avec tous les parametres
			// demandés
			Affichage affichage = new Affichage(
			        index_algo_choisis , index_generation_choisis ,
